...
var commentSpan = document.querySelector("#comment-span");
var deleteCommentBtns = document.querySelectorAll("#delete-comment");
var deleteComment = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(event) {
    var item, id, videoId, commentToDelete;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          id = item.dataset.id;
          item.remove();
          videoId = mainVideoScreen.dataset.id;
          _context.next = 7;
          return (0, _nodeFetch["default"])("/api/videos/".concat(videoId, "/comment/delete"), {
            method: 'DELETE',
            headers: {
...
var showComments = function showComments(text, newCommentId, newOwner) {
  var commentsSection = document.querySelector(".comments-section");
  var commentsUl = commentsSection.querySelector(".comments-ul");
  var commentsLi = document.createElement("li");
  if (!commentsLi) {
    var _commentsLi = document.createElement("span");
    _commentsLi.dataset.id = "";
  }
...
var submitCommentForm = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(submitEvent) {
    var textArea, text, trimedText, videoId, commentResponse, _yield$commentRespons, newCommentId, newOwner;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 12:
          _yield$commentRespons = _context2.sent;
          newCommentId = _yield$commentRespons.newCommentId;
          newOwner = _yield$commentRespons.newOwner;
  ...
  return function submitCommentForm(_x2) {
