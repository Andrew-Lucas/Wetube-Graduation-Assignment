...
var cancelDownloadBtn = document.getElementById("ignore-download");
...
var downloadRecording = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
    var ffmpeg, mp4File, thumbFile, mp4Blob, thumbBlob, mp4Url, thumbUrl, a, thumbA;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 7:
          ...
          _context2.t0.FS.call(_context2.t0, "writeFile", "recording.webm", _context2.t1);
          _context2.next = 11;
          return ffmpeg.run("-i", "recording.webm", "-r", "60", "output.mp4");
        case 11:
          _context2.next = 13;
          return ffmpeg.run("-i", "recording.webm", "-ss", "00:00:01", "-frames:v", "1", "thumbnail.jpg");
        case 13:
          mp4File = ffmpeg.FS("readFile", "output.mp4");
          thumbFile = ffmpeg.FS("readFile", "thumbnail.jpg");
  ...
  return function downloadRecording() {
    return _ref2.apply(this, arguments);
  };
}();
var cancelDownload = function cancelDownload() {
  recordPreview.classList.add("hide-video_preview");
  cancelDownloadBtn.classList.add("hide-video_preview");
  recordBtn.innerText = "Start recording";
  recordBtn.removeEventListener("click", downloadRecording);
